...
export class ToolbarComponent implements OnInit, OnDestroy
{
     ...
     * @param _fuseTranslationLodarService
     * @param authService
     * @param _router
     * @param translate
    ...
    constructor(
        ...
        private _fuseTranslationLodarService: FuseTranslationLoaderService,
    ...
    {
        this._fuseTranslationLodarService.loadTranslations(slovenian, english)
